...
class Line:
    ...
    def process_message(self, message):
        ...
        logger.debug(f"received lines message. key: {message.key()}, value: {message.value()}, topic: {message.topic()}")
        ...
        elif str(message.topic()).startswith("org.chicago.cta.station.arrivals"):  # Set the conditional to the arrival topic
